 ...
 *   ingests.
 *
 *   Program slot (populated by `make sim-tgc5b-soc` or examples/tgc5b_soc/sim.sh):
...
module ct_soc_tb;
	...
	localparam string PROG_PCINFO     = "../../examples/tgc5b_soc/prog/prog.pcinfo";
	...
	initial begin
		$system({"cp ", PROG_PCINFO, " ct_soc_tb.nexrv.info"});
	end
