 ...
 *           AXI plumbing around tgc5b2_axis_soc_top + 2x axi_fifo_mm_s, plain SV
 ...
 *          0xA000_0000  SOC     tgc5b2_axis_soc_top (CTRL/ENC0/ENC1/RAM1/
 ...
 *   clones of the kv260_app pattern (vivado/tgc5b2_axis_wp/gen_ip.tcl) --
 ...
 *   duo_pib_pmod.xdc, tgc5b2_axis_wp.xdc); the PS pads remain implicit.
 *
 ...
 */
module tgc5b2_kv260_top (
	// PIB: parallel trace port (T2) -> KV260 PMOD J2 (tgc5b2_axis_wp.xdc)
	output wire       pib_clk,
	output wire [3:0] pib_data
);

	// Informative mirrors of the build parameters (WPCTRL register; must
	// match gen_ip.tcl's C_RX_FIFO_DEPTH and tgc5b2_axis_soc_top's
	// SHIM_FIFO_DEPTH).
