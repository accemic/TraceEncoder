...
* `tgc5b2_axis_wp_c0b/` -- `.bit.bin` (bootgen, fpga-manager format), device-tree overlay, `shell.json`, and a `MANIFEST.sha256` that verifies the set.
...
bash examples/kv260/common/board/deploy_kv260_app.sh \
     --app-dir examples/kv260/tgc5b2_axis_wp/fpga/prebuilt/tgc5b2_axis_wp_c0b \
...
```bash
cd examples/kv260/tgc5b2_axis_wp/fpga/prebuilt/tgc5b2_axis_wp_c0b && sha256sum -c MANIFEST.sha256
```
