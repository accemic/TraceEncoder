...
# instantiated from duo_kv260_top.sv.
#
...
# widths mis-steer write byte lanes, see duo_kv260_top.sv) -> AXI data
# width converter 128->32 -> AXI4 -> AXI4-Lite protocol converter ->
# duo_soc_top @ 0xA000_0000.
#
...
# ../../trio/fpga/gen_ip.tcl except for this header's top-name references --
...
# at that, the constant-high tie in duo_kv260_top.sv holds everything in
