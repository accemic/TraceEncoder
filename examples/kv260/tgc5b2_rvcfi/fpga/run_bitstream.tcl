...
# synth_1 -> impl_1 -> write_bitstream with top tgc5b2_rvcfi_kv260_top, a WNS
# check, and utilization/timing reports written to reports/ (raw-data
# obligation).
#
#   vivado -mode batch -notrace -source examples/kv260/tgc5b2_rvcfi/fpga/run_bitstream.tcl
#
...
set proj       [file join $script_dir proj tgc5b2_rvcfi.xpr]
set rpt_tag    tgc5b2_rvcfi
