...
# instantiated from mbv_kv260_top.sv.
#
...
# widths mis-steer write byte lanes, see mbv_kv260_top.sv) -> AXI data
# width converter 128->32 -> AXI4 -> AXI4-Lite protocol converter ->
# mbv_soc_top @ 0xA000_0000.
#
...
# This is the vivado/kv260_app-family copy
# (S_AXI_GP2/GP3 enabled below for the DDR trace sink / CVA6 memory path used
# by sibling kv260_app tops -- duo/trio -- that share this Zynq PS IP
# configuration; mbv_kv260_top.sv itself ties those inputs off). It is
# provisions the single-core case -- kept byte-faithful to the flow that built
# and board-verified this example's bitstream rather than silently trimmed
# during migration.
...
# (ct_soc_ddr_sink AXI master). Used by duo_kv260_top/trio_kv260_top and,
# since D2 (2026-08-18), by mbv_kv260_top too -- the single-core top gained
# the same three-sink subsystem (ct_trace_sinks) and now drives saxigp2
# instead of tying its inputs off.
...
# at that, the constant-high tie in mbv_kv260_top.sv holds everything in
