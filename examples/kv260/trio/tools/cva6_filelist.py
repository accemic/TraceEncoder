...
hpdcache.Flist). XSIM needs a resolved, absolute list from us (one path per
line), or the +incdir+ directories (--incdirs).

    py tools/cva6_filelist.py third_party/cva6_ref/core/Flist.cva6 --target cv32a60x
    py tools/cva6_filelist.py ... --incdirs
