...
# renamed, non-`duo_`-prefixed filename rather than cross-referenced into
# the duo example's (concurrently, independently migrated) directory -- see
# ../../rocket_linux/fpga/rocket_pib_pmod.xdc for the full rationale (this
# is the same content, duplicated into this example too, same reasoning as
# gen_ip.tcl/abc_filelist.py).
