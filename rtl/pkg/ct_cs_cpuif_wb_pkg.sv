...
package ct_cs_cpuif_wb_pkg;
	...
	localparam logic [31:0] ADDR_TE_TRTEPROTOCOLSEL             = 32'h00000030;
	...
	localparam logic [31:0] ADDR_TE_TRTETRIGDBGCONTROL          = 32'h00000050;
	localparam logic [31:0] ADDR_TE_TRTETRIGEXTINCONTROL        = 32'h00000054;
	localparam logic [31:0] ADDR_TE_TRTETRIGEXTOUTCONTROL       = 32'h00000058;
	...
	localparam logic [31:0] ADDR_TE_TRTECOMP_SMASKLOW           = 32'h00000608;  // 8 instances, stride 0x20
	localparam logic [31:0] ADDR_TE_TRTECOMP_SMASKHIGH          = 32'h0000060C;  // 8 instances, stride 0x20
	...
	localparam logic [31:0] ADDR_TE_TRTESYNCSTATUS              = 32'h00000E08;
	localparam logic [31:0] ADDR_TE_TRTETIPFIFOHISTCTRL         = 32'h00000E10;
	localparam logic [31:0] ADDR_TE_TRTETIPFIFOHISTDATA         = 32'h00000E14;
	...
	localparam logic [31:0] ADDR_TRWPMASK                       = 32'h00004008;
	localparam logic [31:0] ADDR_TRWPINDEX                      = 32'h0000400C;
	localparam logic [31:0] ADDR_TRWPDATALOW                    = 32'h00004010;
	localparam logic [31:0] ADDR_TRWPDATAHIGH                   = 32'h00004014;
	localparam logic [31:0] ADDR_TRWPREADLOW                    = 32'h00004018;
	localparam logic [31:0] ADDR_TRWPREADHIGH                   = 32'h0000401C;
	localparam logic [31:0] ADDR_TRWPCAP                        = 32'h00004020;
	...
	localparam int BITPOS_te_trTeControl_InstSeqSyncEnable         = 10;
	localparam int BITPOS_te_trTeControl_InstTrigEnable            = 11;
	localparam int BITPOS_te_trTeControl_InstStallOrOverflow       = 12;
	...
	localparam int BITPOS_te_trTeControl_SendDeviceId_LSB         = 28;
	localparam int BITPOS_te_trTeControl_SendDeviceId_MSB         = 29;
	localparam int WIDTH_te_trTeControl_SendDeviceId             = 2;
	...
	localparam int BITPOS_te_trTeInstFeatures_InstEnImplicitReturn = 3;
	localparam int BITPOS_te_trTeInstFeatures_InstEnBranchPrediction = 4;
	localparam int BITPOS_te_trTeInstFeatures_InstEnJumpTargetCache = 5;
	localparam int BITPOS_te_trTeInstFeatures_InstEnRepeatedHistory = 8;
	localparam int BITPOS_te_trTeInstFeatures_InstEnRepeatBranch   = 11;
	localparam int BITPOS_te_trTeInstFeatures_InstEnWideIcnt       = 12;
	localparam int BITPOS_te_trTeInstFeatures_InstEnIbhs           = 13;
	localparam int BITPOS_te_trTeInstFeatures_InstEnRepeatInstr    = 14;
	...
	localparam int BITPOS_te_trTeDataControl_DataStallOrOverflow   = 3;
	localparam int BITPOS_te_trTeDataControl_DataDrop              = 5;
	localparam int BITPOS_te_trTeDataControl_DataDropEna           = 6;
	...
	localparam int BITPOS_te_trTeProtocolSel_Protocol              = 0;
	...
	localparam int BITPOS_te_trTeTrigDbgControl_TrigDbgSetup_LSB  = 0;
	localparam int BITPOS_te_trTeTrigDbgControl_TrigDbgSetup_MSB  = 31;
	localparam int WIDTH_te_trTeTrigDbgControl_TrigDbgSetup      = 32;

	// Register: te_trTeTrigExtInControl @ 0x0054
	localparam int BITPOS_te_trTeTrigExtInControl_ExtInAction0_LSB = 0;
	localparam int BITPOS_te_trTeTrigExtInControl_ExtInAction0_MSB = 3;
	localparam int WIDTH_te_trTeTrigExtInControl_ExtInAction0    = 4;
	localparam int BITPOS_te_trTeTrigExtInControl_ExtInActionN_LSB = 4;
	localparam int BITPOS_te_trTeTrigExtInControl_ExtInActionN_MSB = 31;
	localparam int WIDTH_te_trTeTrigExtInControl_ExtInActionN    = 28;

	// Register: te_trTeTrigExtOutControl @ 0x0058
	localparam int BITPOS_te_trTeTrigExtOutControl_ExtOutEvent0_LSB = 0;
	localparam int BITPOS_te_trTeTrigExtOutControl_ExtOutEvent0_MSB = 3;
	localparam int WIDTH_te_trTeTrigExtOutControl_ExtOutEvent0   = 4;
	localparam int BITPOS_te_trTeTrigExtOutControl_ExtOutEventN_LSB = 4;
	localparam int BITPOS_te_trTeTrigExtOutControl_ExtOutEventN_MSB = 31;
	localparam int WIDTH_te_trTeTrigExtOutControl_ExtOutEventN   = 28;
	...
	localparam int BITPOS_te_trTeComp_SMaskLow_Value_LSB          = 0;
	localparam int BITPOS_te_trTeComp_SMaskLow_Value_MSB          = 31;
	localparam int WIDTH_te_trTeComp_SMaskLow_Value              = 32;

	// Register: te_trTeComp_SMaskHigh @ 0x060C
	localparam int BITPOS_te_trTeComp_SMaskHigh_Value_LSB         = 0;
	localparam int BITPOS_te_trTeComp_SMaskHigh_Value_MSB         = 31;
	localparam int WIDTH_te_trTeComp_SMaskHigh_Value             = 32;
	...
	localparam int BITPOS_te_trTeSyncStatus_SyncReqSource_LSB     = 0;
	localparam int BITPOS_te_trTeSyncStatus_SyncReqSource_MSB     = 2;
	localparam int WIDTH_te_trTeSyncStatus_SyncReqSource         = 3;

	// Register: te_trTeTipFifoHistCtrl @ 0x0E10
	localparam int BITPOS_te_trTeTipFifoHistCtrl_HistClear         = 0;
	localparam int BITPOS_te_trTeTipFifoHistCtrl_RdRewind          = 1;
	localparam int BITPOS_te_trTeTipFifoHistCtrl_RdIdx_LSB        = 8;
	localparam int BITPOS_te_trTeTipFifoHistCtrl_RdIdx_MSB        = 12;
	localparam int WIDTH_te_trTeTipFifoHistCtrl_RdIdx            = 5;

	// Register: te_trTeTipFifoHistData @ 0x0E14
	localparam int BITPOS_te_trTeTipFifoHistData_Lo_LSB           = 0;
	localparam int BITPOS_te_trTeTipFifoHistData_Lo_MSB           = 15;
	localparam int WIDTH_te_trTeTipFifoHistData_Lo               = 16;
	localparam int BITPOS_te_trTeTipFifoHistData_Hi_LSB           = 16;
	localparam int BITPOS_te_trTeTipFifoHistData_Hi_MSB           = 31;
	localparam int WIDTH_te_trTeTipFifoHistData_Hi               = 16;
	...
	localparam int BITPOS_trWpMask_WEM_LSB                        = 0;
	localparam int BITPOS_trWpMask_WEM_MSB                        = 15;
	localparam int WIDTH_trWpMask_WEM                            = 16;

	// Register: trWpIndex @ 0x400C
	localparam int BITPOS_trWpIndex_Idx_LSB                       = 0;
	localparam int BITPOS_trWpIndex_Idx_MSB                       = 15;
	localparam int WIDTH_trWpIndex_Idx                           = 16;

	// Register: trWpDataLow @ 0x4010
	localparam int BITPOS_trWpDataLow_Value_LSB                   = 0;
	localparam int BITPOS_trWpDataLow_Value_MSB                   = 31;
	localparam int WIDTH_trWpDataLow_Value                       = 32;

	// Register: trWpDataHigh @ 0x4014
	localparam int BITPOS_trWpDataHigh_Cmd_LSB                    = 0;
	localparam int BITPOS_trWpDataHigh_Cmd_MSB                    = 5;
	localparam int WIDTH_trWpDataHigh_Cmd                        = 6;
	localparam int BITPOS_trWpDataHigh_Sink_LSB                   = 6;
	localparam int BITPOS_trWpDataHigh_Sink_MSB                   = 7;
	localparam int WIDTH_trWpDataHigh_Sink                       = 2;
	localparam int BITPOS_trWpDataHigh_DirectData_LSB             = 8;
	localparam int BITPOS_trWpDataHigh_DirectData_MSB             = 31;
	localparam int WIDTH_trWpDataHigh_DirectData                 = 24;

	// Register: trWpReadLow @ 0x4018
	localparam int BITPOS_trWpReadLow_Value_LSB                   = 0;
	localparam int BITPOS_trWpReadLow_Value_MSB                   = 31;
	localparam int WIDTH_trWpReadLow_Value                       = 32;

	// Register: trWpReadHigh @ 0x401C
	localparam int BITPOS_trWpReadHigh_Cmd_LSB                    = 0;
	localparam int BITPOS_trWpReadHigh_Cmd_MSB                    = 5;
	localparam int WIDTH_trWpReadHigh_Cmd                        = 6;
	localparam int BITPOS_trWpReadHigh_Sink_LSB                   = 6;
	localparam int BITPOS_trWpReadHigh_Sink_MSB                   = 7;
	localparam int WIDTH_trWpReadHigh_Sink                       = 2;
	localparam int BITPOS_trWpReadHigh_DirectData_LSB             = 8;
	localparam int BITPOS_trWpReadHigh_DirectData_MSB             = 31;
	localparam int WIDTH_trWpReadHigh_DirectData                 = 24;

	// Register: trWpCap @ 0x4020
	localparam int BITPOS_trWpCap_Entries_LSB                     = 0;
	localparam int BITPOS_trWpCap_Entries_MSB                     = 15;
	localparam int WIDTH_trWpCap_Entries                         = 16;
