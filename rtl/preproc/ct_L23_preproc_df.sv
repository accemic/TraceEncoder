...
module ct_L23_preproc_df #(
	...
	parameter int EXTRA_DELAY_MAX = ct_pkg::EXTRA_DELAY_MAX,
	// When 1: LOADs emit df_qualifier.hit at lresp time (not dretire); STOREs unchanged.
	// Compatible with TGC5C AXI4 H2E v1.1 split-load interface (sdata/lresp/ldata).
	...
	assign lresp_valid   = tip.lresp[1]; // bit[1]=1: lresp=2 (OK) or 3 (error) per TGC H2E spec
