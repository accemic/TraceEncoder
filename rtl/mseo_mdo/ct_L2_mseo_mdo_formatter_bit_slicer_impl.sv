 ...
 */
module ct_L2_mseo_mdo_formatter_bit_slicer_impl #(
	...
	// Area/throughput knob (ct_pkg): 2 = one boundary crossing per cycle
	// (historical), 1 = single-step datapath (smaller, assembly may take an
	// extra cycle at field boundaries; wire bytes identical).
	localparam int unsigned MAX_STEPS_PER_CYCLE = ct_pkg::CT_SLICER_STEPS;
