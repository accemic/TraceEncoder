...
/**
 * @brief Generates MSEO patterns and stalls data slices during control-only cycles.
 *
 * @details
 *   Implements the single-pin and dual-pin MSEO sequencing required by
 *   IEEE-ISTO-5001-2012 Section 5 (Table 5-1):
 *
 *   Single-pin MSEO sequences:
 *    - Idle: 1
 *    - Start of message: 1,1,0
 *    - End of variable-length packet: 0,1,0
 *    - End of message: 0,1,1,1,1,...
 *
 *   Dual-pin MSEO sequences:
 *    - Idle: 11
