...
module ct_axis_dump #(
	// NOTE: In Vivado XSim, the simulation working directory is typically
	//   <repo>/ct_tb.vivado/ct_tb.sim/sim_1/behav/xsim
	// Therefore, using a repo-root relative path would fail unless it is made
	// relative to that working directory.
	//
	// This default points back to the repo root and then into
	//   modules/ctrace/test/runs
	//
	// If you run this dumper in a different simulation setup, override OUT_DIR.
	string  OUT_DIR                  = "../../../../../../modules/ctrace/test/runs",
