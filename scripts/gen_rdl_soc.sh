...
#
# Regenerate the example SoC peripheral register block from examples/kv260/common/tgc5b/rdl/ct_soc.rdl.
#
...
#   examples/kv260/common/tgc5b/pkg/ct_soc_regs.sv       PeakRDL-regblock — register block
#   examples/kv260/common/tgc5b/pkg/ct_soc_regs_pkg.sv   PeakRDL-regblock — hwif struct package
#
...
RDL=examples/kv260/common/tgc5b/rdl/ct_soc.rdl
REQ=rdl/requirements.txt
VENV=.venv-rdl
PYTHON="${PYTHON:-python3}"
OUTDIR=examples/kv260/common/tgc5b/pkg
...
# in ct_soc.rdl (ct_soc, ct_soc_top) are documentation. -I examples/kv260/common/tgc5b/rdl resolves the
# `include-d component files under examples/kv260/common/tgc5b/rdl/ct_soc/; -I rdl resolves
# the encoder addrmap (ct_cs_cpuif.rdl) instantiated by the documentation maps.
echo "[gen_rdl_soc] peakrdl regblock -> $OUTDIR/"
peakrdl regblock "$RDL" -o "$TMP" -I examples/kv260/common/tgc5b/rdl -I rdl -t ct_soc_periph \
...
echo "[gen_rdl_soc] done. Commit examples/kv260/common/tgc5b/rdl/ct_soc.rdl and the regenerated SV together."
